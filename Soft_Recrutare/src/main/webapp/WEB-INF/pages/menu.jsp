            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item ${pageContext.request.requestURI eq '/JR_HR/register.jsp' ? ' active' : ''}">
                        <a class="nav-link" href="${pageContext.request.contextPath}/register.jsp">Register<span class="sr-only">(current)</span></a>
                    </li>

                    <li class="nav-item ${pageContext.request.requestURI eq 'JR_HR/users.jsp' ? ' active' : ''}">
                        <a class="nav-link" href="${pageContext.request.contextPath}/users.jsp">Users<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
